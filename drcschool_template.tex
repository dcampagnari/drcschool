...
\small\today
\end{center}
Dieses Dokument ist nicht wirklich eine Dokumentation, sondern eher eine
...
nach noch nicht ganz reif sind und ich sie daher noch nicht als ganz ,,offiziell``
...
\item[\opt{nopgfplots}] Das Gleiche gilt ähnlich für \pkg{pgfplots}. Will man die \TikZ-Fähigkeiten
   haben aber braucht man keine Funktionen zu plotten, so kann man diese Option verwenden
...
\section{,,Geschlossenes`` Wurzelsymbol}
