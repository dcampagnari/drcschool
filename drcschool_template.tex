...
\exercise[2+2+3+3]
Hat man mehrere Teilaufgaben, kann man die Teilpunkte entweder als optionalen Parameter
zu \cs{question} angeben, oder direkt als ,,Summe`` im optionalen Parameter zu
\cs{exercise}. Auch da kann man Dezimalzahlen verwenden, mit oder ohne Komma.
\begin{solution}
